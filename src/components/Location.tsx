    ...
    >
      ...
      >
        <a href="https://www.google.com/maps/place//data=!4m2!3m1!1s0x94ce5850b9b27e57:0x4d3f8cca5893ddd8?source=g.page.share" target='_blank' className='h-full'>
          <img src={tab1} alt="" className='w-screen' />
        </a>
      </Tabs.Content>
      ...
      >
        <a href="https://www.google.com/maps/place/Rei+do+iPhone+2%C2%AA+Unidade/@-23.5850316,-46.6781399,19z/data=!3m1!4b1!4m5!3m4!1s0x94ce57f3abdf5263:0xed9fbc5627e160e4!8m2!3d-23.5850316!4d-46.6775914?shorturl=1" target='_blank'>
          <img src={tab2} alt="" className='w-screen max-h-[538px] lg' />
        </a>
      </Tabs.Content>
      <Tabs.List className="lg:flex lg:gap-4 lg:mt-10 flex mr-36 transition-transform duration-200" aria-label="Manage your account">
        <Tabs.Trigger
          ...
          value="tab1"
        >
          <div className='items-center text-sm w-60 '>
        ...
        <Tabs.Trigger
          ...
          value="tab1"
        >
          <div className='items-center text-xs w-30'>
        ...
        >
          <div className='items-center text-xs w-30'>
            ...
            <p className='font-thin'>R. João Cachoeira, 567
              Itaim Bibi - SP</p>
          </div>
        </Tabs.Trigger>
      </Tabs.List>
